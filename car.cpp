...
void Car::simulation()
{
    ...
    this->addNewTank(QDate(2010,11,15),km += 850,52,70,true,0);
    this->addNewTank(QDate(2010,11,29),km += 981,55,74,true,1);
    this->addNewTank(QDate(2010,11,15),km += 1042,47,63,true,2);
    this->addNewTank(QDate(2010,11,29),km += 1021,48,60,true,3);
    this->addNewTank(QDate(2010,12,15),km += 1051,60,70,true,1);
    this->addNewCost(QDate(2011, 1, 1),km += 100,"Revision 5000",50);
    this->addNewTank(QDate(2011, 1,29),km += 1101,60,70,true,1);
    this->addNewTank(QDate(2011, 1,15),km += 1099,60,70,true,2);
    this->addNewTank(QDate(2011, 1,29),km += 1080,60,70,true,3);
    this->addNewTank(QDate(2011, 2,15),km += 1010,60,70,true,1);
    this->addNewTank(QDate(2011, 2,29),km += 1071,60,70,true,2);
    this->addNewTank(QDate(2011, 3, 5),km += 1031,60,70,true,2);
    ...
    this->addNewTank(QDate(2011, 7,18),km += 1027,60,70,true,1);
    ...
    this->addNewTank(QDate(2013,11,29),km += 1080,60,70,true,3);
