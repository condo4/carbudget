...
class Tank : public CarEvent
{
    ...
    Q_PROPERTY(QString      fueltype    READ fueltype   WRITE setFueltype       NOTIFY fueltypeChanged )
...
public:
    ...
    explicit Tank(QDate date, unsigned int distance, double quantity, double price, bool full, unsigned int station, unsigned int id, QString fueltype, QString note, Car* parent);
